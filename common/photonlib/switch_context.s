...
.globl _photon_switch_context_new
#if !defined( __APPLE__ ) && !defined( __FreeBSD__ )
.type  _photon_switch_context_new, @function
#endif
_photon_switch_context_new: //(thread* from, thread* to)
...
.globl _photon_die_and_jmp_to_context_new
#if !defined( __APPLE__ ) && !defined( __FreeBSD__ )
.type  _photon_die_and_jmp_to_context_new, @function
#endif
_photon_die_and_jmp_to_context_new: //(void* th, void** c)
